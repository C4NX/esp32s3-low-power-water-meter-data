...
static esp_event_handler_instance_t ip_spa_event_handler;
static esp_event_handler_instance_t wifi_spa_event_handler;

static EventGroupHandle_t s_wifi_event_group = NULL;

// Handle Wi-Fi events
static void wifi_sta_event_handler_callback(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
...
// Handle IP events
static void ip_sta_event_callback(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
...
esp_err_t app_wifi_sta_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_event_handler_instance_register(WIFI_EVENT,
                                                        ESP_EVENT_ANY_ID,
                                                        &wifi_sta_event_handler_callback,
                                                        NULL,
                                                        &wifi_spa_event_handler));
    ESP_ERROR_CHECK(esp_event_handler_instance_register(IP_EVENT,
                                                        ESP_EVENT_ANY_ID,
                                                        &ip_sta_event_callback,
                                                        NULL,
                                                        &ip_spa_event_handler));
    return ret;
}
...
esp_err_t app_wifi_sta_deinit(void)
{
    ...
    ESP_ERROR_CHECK(esp_event_handler_instance_unregister(IP_EVENT, ESP_EVENT_ANY_ID, ip_spa_event_handler));
    ESP_ERROR_CHECK(esp_event_handler_instance_unregister(WIFI_EVENT, ESP_EVENT_ANY_ID, wifi_spa_event_handler));
